...
const notifyJid = '94775686166@s.whatsapp.net'; // Target JID for connection message
...
async function connectToWA() {
    ...
    sock.ev.on('connection.update', async (update) => {
        ...
        if (connection === 'close') {
            ...
            if (shouldReconnect) {
                console.log('Reconnecting❤️...');
                connectToWA();
            }
        } else if (connection === 'open') {
            console.log('Connected to WhatsApp❤️✅');
            sock.sendMessage(notifyJid, { text: 'Bitx News❤️😎 connected and ready to work!' });
    ...
    sock.ev.on('messages.upsert', async ({ messages }) => {
        ...
        if (text === '.active') {
            ...
            if (!config.activeJids.includes(jid)) {
                ...
                activeChats.add(jid);
                await sock.sendMessage(jid, { text: 'News bot is now active for this chatfor ,jid' });
